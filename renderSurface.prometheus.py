...
if __name__ == "__main__":
    ...
    #                               hauteur
    #STARTCOORD = minecraft.Vec3(200,  80,    0)
    STARTCOORD = minecraft.Vec3( playerPos.x, 80, playerPos.z)
    ...
    SWAPYZ = False
    vertices,textures,normals,faces,materials = load_obj("obj/prometheus.obj", DEFAULTBLOCK, MATERIALS)
